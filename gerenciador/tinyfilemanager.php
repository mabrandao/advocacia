<?php
if(!isset($_SESSION['tokenrr'])){
    session_start();
}

if(isset($_GET['tokenrr']) and $_GET['tokenrr'] == "dfbs8fgd61vdfvdv542@ff52364"){    
    $_SESSION['tokenrr'] = true;
}else{
    if(!isset($_SESSION['tokenrr']) and !$_SESSION['tokenrr']){
        echo "Token Inválido";
        exit;
    }    
}
...
$CONFIG = '{"lang":"pt","error_reporting":true,"show_hidden":false,"hide_Cols":false,"theme":"light"}';
...
//Application Title
define('APP_TITLE', 'Gerenciador de Arquivos');
...
$root_path = $_SERVER['DOCUMENT_ROOT']."/advocacia/assets/img/upload";

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url =  'advocacia/assets/img/upload';
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="btn-group btn-group-sm flex-wrap" role="group">
                ...
                <a class="fw-bold btn btn-outline-success" href="#" onclick="retornar_caminho('<?php echo $file_url ?>')"><i class="fa fa-external-link-square"></i> Selecionar </a></b>
                <?php
                // ZIP actions
        ...
        ?>
            ...
            <script>
                ...
                function selectImage(imageUrl) {
                    // Chama o callback do TinyMCE com a URL da imagem
                    window.parent.tinyMCE.activeEditor.execCommand('mceInsertContent', false, '<img src="' + imageUrl + '" alt="Imagem">');
                    // Fecha o modal
