...
// Removendo a linha problemática: mb_http_input('UTF-8');
mb_language('uni');
mb_regex_encoding('UTF-8');
ob_start('mb_output_handler');
date_default_timezone_set('America/Manaus'); // Ajustando para o timezone do Brasil
setlocale(LC_CTYPE, 'pt_BR.UTF-8'); // Ajustando para português do Brasil
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => '/advocacia/assets/img/upload/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |
    */
    'thumbs_upload_dir' => '/advocacia/assets/vendor/filemanager/thumbs/',
    ...
    */
    ...
    'access_keys' => ['jgvfghge4egh5e5heg'],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'default_folders' => array('images', 'files', 'documents'),
    ...
    */
    ...
    'ext_file' => array('doc', 'docx', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'xml', 'zip', 'rar', 'gz', 'tar'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | If you want to be even more specific about which files can be uploaded,
    | create an array of mime types that are allowed.
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Return relative url (false => return absolute url)
    |--------------------------------------------------------------------------
    */
    ...
    |
    */
    'files_and_folders_access' => array(
